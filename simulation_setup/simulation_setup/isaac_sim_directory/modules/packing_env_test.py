        ...
        self.observation_space = spaces.Dict(
            {
                ...
                "boxes": spaces.Box(0, self.box_size - 1, shape=(self.no_items, 3), dtype=np.float64), #spaces.Tuple((spaces.Discrete(self.no_items) for _ in range(3)))
            }
        )
