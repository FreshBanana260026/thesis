...
class PackingEnvNp(gym.Env):
    ...
    def __init__(self, render_mode = "human", size = 40):
    ...
    #returns volume used inside the bin
    ...
    #returns bins bottom area that is in contact with packages
    def get_area_used(self):
        return np.count_nonzero(self._observation)/16 #in %
    ...
    # THIS FUNCTION IS ONLY FOR VISUALIZATION IN PYGAME
